...
<head>
    ...
    <title>Editar Producto - POSYSTEM</title>
    <script>
        tailwind.config = {
            theme: {
                extend: {
...
<body>
    <div class="flex h-screen overflow-hidden">
        ...
        <!-- Contenido principal -->
        <main class="flex-1 bg-slate-100 h-screen overflow-y-auto">

            <!-- Barra superior -->
            <div class="sticky top-0 z-10 bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <a href="../Pages/inventario.php" class="flex items-center gap-2 text-blue-600 hover:text-blue-800 text-sm font-medium transition-all duration-300">
                        <i data-lucide="arrow-left" class="w-4 h-4"></i>
                        Volver al Inventario
                    </a>
                    <span class="text-slate-300">|</span>
                    <h2 class="text-sm font-bold text-slate-800">Editar Producto</h2>
                </div>
                <div class="flex items-center gap-3">
                    <a href="../Pages/inventario.php" class="px-4 py-2 text-sm font-medium text-slate-500 hover:text-slate-700 transition-all duration-300">
                        Descartar
                    </a>
                    <button type="submit" form="form-editar" class="px-5 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-sm">
                        Guardar Cambios
                    </button>
                </div>
            </div>
            ...
            <div class="p-8">
                ...
                <div class="mb-8">
                    <h1 class="text-2xl font-bold text-slate-800"><?= htmlspecialchars($producto['nombre']) ?></h1>
                ...
                <form id="form-editar" action="actualizar.php" method="POST" class="flex gap-6">
                    ...
                    <div class="flex-1 flex flex-col gap-6">
                        ...
                        <div class="bg-white rounded-xl border border-slate-200 p-6">
                            <div class="flex items-center gap-3 mb-5">
                                <span class="text-xs font-bold text-blue-600 uppercase tracking-wider">Sección 01</span>
                            ...
                            <div class="mb-4">
                                <label for="nombre" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Nombre del Producto</label>
                        ...
                        <div class="flex gap-6">
                            ...
                            <div class="flex-1 bg-white rounded-xl border border-slate-200 p-6">
                                <div class="flex items-center gap-3 mb-5">
                                    <span class="text-xs font-bold text-blue-600 uppercase tracking-wider">Sección 02</span>
                                    <h3 class="text-lg font-bold text-slate-800">Precio y Categoría</h3>
                                </div>

                                <div class="mb-4">
                                    <label for="precio" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Precio</label>
                                    <div class="relative">
                                        ...
                                        <input type="number" id="precio" name="precio" value="<?= $producto['precio'] ?>" step="0.01" min="0"
                                            class="w-full pl-8 pr-4 py-3 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 bg-slate-50"
                                            required>
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <label for="id_categoria" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Categoría</label>
                                ...
                                <div>
                                    <label for="sku" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">SKU</label>
                            ...
                            <div class="flex-1 bg-white rounded-xl border border-slate-200 p-6">
                                <div class="flex items-center gap-3 mb-5">
                                    <span class="text-xs font-bold text-blue-600 uppercase tracking-wider">Sección 03</span>
                                    <h3 class="text-lg font-bold text-slate-800">Stock</h3>
                                </div>

                                <div class="mb-4">
                                    <label for="stock" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Stock Actual</label>
                                    <input type="number" id="stock" name="stock" value="<?= $producto['stock'] ?>" min="0"
                                        class="w-full px-4 py-3 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 bg-slate-50">
                                </div>

                                <div class="mb-4">
                                    <label for="stock_minimo" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Stock Mínimo</label>
                    ...
                    <div class="w-80">
                        <div class="bg-white rounded-xl border border-slate-200 p-6">
                            <div class="flex items-center gap-3 mb-5">
                                <span class="text-xs font-bold text-blue-600 uppercase tracking-wider">Sección 04</span>
                                <h3 class="text-lg font-bold text-slate-800">Imagen</h3>
                            </div>

                            <!-- Vista previa de imagen -->
                            <div class="w-full h-52 bg-slate-50 rounded-xl border border-slate-200 overflow-hidden flex items-center justify-center mb-4">
                                ...
                                <?php else: ?>
                                    <div class="flex flex-col items-center gap-2 text-slate-300" id="img-placeholder">
                            ...
                            <div>
                                <label for="imagen_url" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">URL de Imagen</label>
                        ...
                        <div class="bg-white rounded-xl border border-red-200 p-6 mt-6">
                            ...
                            <p class="text-xs text-slate-500 mb-4">Esta acción no se puede deshacer. El producto será eliminado permanentemente.</p>
