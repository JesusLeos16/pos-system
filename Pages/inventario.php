    ...
    <div class="flex">
        ...
        <main class="flex-1 bg-neutral min-h-screen ml-64 p-8">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-2xl font-heading font-bold text-tertiary-dark">Inventario</h2>
                    <p class="text-tertiary-light text-sm mt-1">Administra tus productos, categorías y stock.</p>
                </div>
                <a href="../productos/crear.php" class="flex items-center gap-2 px-5 py-3 bg-tertiary text-white text-sm font-heading font-semibold rounded-lg hover:bg-tertiary-dark transition-all duration-300 shadow-sm">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-primary/20">
                ...
                <!-- Footer de la tabla -->
                <div class="flex items-center justify-between px-6 py-4 border-t border-primary/20">
